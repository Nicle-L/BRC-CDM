...
def load_dataset(data_config):
    ...
    if dataset_name == "kth_actions":
        ...
        transforms = trans.Compose(transforms)
        train = IMG(os.path.join(data_path, "Kodak"), transforms)
        val = IMG(os.path.join(data_path, "Kodak"), transforms)
    elif dataset_name == "clic":
        from .datasets import IMG
        transforms = [
            trans.ImageToTensor(),
            trans.ConcatSequence(),
        ...
        transforms = trans.Compose(transforms)
        train = IMG(os.path.join(data_path, "clic_train"), transforms)
        val = IMG(os.path.join(data_path, "clic_test"), transforms)
